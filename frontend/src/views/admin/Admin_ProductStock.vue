    ...
    <div class="stats-row">
      ...
      <div class="stat-card card-stock">
        ...
        <div class="stat-info">
          ...
          <div class="stat-sub">全部商品库存数量</div>
        </div>
      </div>
    ...
    >
      <el-form :model="form" :rules="rules" ref="form" label-width="80px" class="stock-form">
        ...
        <el-form-item label="单位" prop="unit">
          <el-input v-model="form.unit" placeholder="如：个、包、箱" />
        </el-form-item>
      ...
      <div class="detail-body" v-if="currentDetailItem">
        <div class="detail-grid">
          ...
          <div class="detail-item">
            ...
            <span class="d-value">{{ currentDetailItem.unit || '个' }}</span>
          </div>
          <div class="detail-item">
...
<script>
import { getInventoryList, addInventory, addStock, deleteInventory, exportProductInventoryList } from '@/api/inventory';
...
@media (max-width: 768px) {
  .product-stock-page { padding: 12px; }
